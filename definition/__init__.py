...
class definition(Plugin):
    ...
    @register("fr-FR", u"(definiere | definier | Erkläre | Beschreibung | Definition) (.*)")
    def define(self, speech, language, regMatched):
        query = regMatched.group(regMatched.lastindex).strip()
        self.say(u"Ich suche die Definition von  "+query+"...")
        ...
        if definition != None:
            ...
            self.say(u"Ich habe keine Definition gefunden fuer " + query)
